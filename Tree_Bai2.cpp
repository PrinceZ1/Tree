/*Cho cây nhị phân, nhiệm vụ của bạn là duyệt cây theo thứ tự Preorder. Thứ tự duyệt Preorder của cây nhị phân bên dưới xuất hiện trong test case mẫu.image
